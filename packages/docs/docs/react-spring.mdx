...
Use `"@pixi/react-pixi-animated"` to import react-spring animated components.
If you're using `"@pixi/react-pixi-legacy"` make sure to use `"@pixi/react-pixi-animated-legacy"`.
...
import { Stage, Sprite } from '@pixi/react-pixi-animated';
