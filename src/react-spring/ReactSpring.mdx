...
>
> When using npm you'll need to enable react-spring `sideEffects`,
> execute the following in your CLI after installing react-spring@next and @inlet/react-pixi:
>
> `node ./node_modules/@inlet/react-pixi/postinstall.js`
