...
ReactPixi already covers a large set of PixiJS components (like `<Container>`, `<Sprite>`, `<Graphics>` and many more), but in some use cases you'd like to add new "reconciler primitive" components.
