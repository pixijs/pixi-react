...
<Meta title="Stage" component={Stage} />
...
`renderOnComponentChange` render stage on component changes. Only useful in combination with `raf` disabled; Default: `true`

`options`; Default: see [PIXI.Application options](https://pixijs.download/release/docs/PIXI.Application.html)
...
export const RenderOnComponentChange = () => {
...
export const RenderOnComponentChangeTemplate = (args) => (
  <RenderOnComponentChange />
)

<Canvas>
  <Story name="renderOnComponentChange">
    {RenderOnComponentChangeTemplate.bind({})}
  </Story>
</Canvas>
...
export const ManualUpdateTemplate = (args) => (
  <ManualUpdate />
)

<Canvas>
  <Story name="manualUpdate">
    {ManualUpdateTemplate.bind({})}
  </Story>
</Canvas>
