...
export function configurePixiReactStage(PixiReactFiber)
{
    class Stage extends React.Component
    {
        ...
        componentDidMount()
        {
            ...
            this.mountNode = PixiReactFiber.createContainer(this.app.stage);
            PixiReactFiber.updateContainer(this.getChildren(), this.mountNode, this);
        ...
        componentWillUnmount()
        {
            ...
            PixiReactFiber.updateContainer(null, this.mountNode, this);
