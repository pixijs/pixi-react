...
<img src="https://user-images.githubusercontent.com/17828231/61295022-6ffa6980-a7d7-11e9-9bff-e71670156cca.png" style={{ maxWidth: '100%', width: 500 }}/>
    ...
    const Bunny = () => {
      ...
      useTick(delta => {
        ...
        update({ type: 'update', data: {
          ...
          rotation: -10 + Math.sin(i/10 + Math.PI * 2) * 10
          } })
      });

      return (
        <Sprite image="https://s3-us-west-2.amazonaws.com/s.cdpn.io/693612/IaUrttj.png" anchor={.5} {...motion} />
      )
    };
