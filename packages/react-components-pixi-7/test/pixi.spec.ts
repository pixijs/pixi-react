...
describe('pixi', () =>
{
    describe('parsePoint', () =>
    {
        ...
        {
            // deliberately casting to test JS runtime case
            expect(parsePoint(undefined as unknown as PointLike)).toEqual([]);
        });

        test('parse null', () =>
        {
            // deliberately casting to test JS runtime case
            expect(parsePoint(null as unknown as PointLike)).toEqual([]);
        });
